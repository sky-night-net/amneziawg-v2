...
const messages = { // eslint-disable-line no-unused-vars
  en: {
    ...
    clients: 'Clients',
    new: 'New',
    appSubtitle: 'AmneziaWG V2 Professional Hub',
    appDesigner: 'Designed by @sky-night-net',
    ...
    setupTitle: 'Initial Server Setup',
    setupSubtitle: 'Configure your VPN node before creating clients.',
    setupHost: 'Server IP or Hostname',
    setupPort: 'WireGuard Port',
    ...
    servers: 'Servers',
    addNode: 'Add Server',
    nodeUrl: 'Server URL (e.g. http://ip:161)',
    nodeToken: 'Agent Token',
    nodeStatus: 'Status',
  ...
  ua: {
    ...
    OneTimeLink: 'Одноразове посилання',
    setupTitle: 'Початкове налаштування',
    setupSubtitle: 'Налаштуйте VPN-вузол перед створенням клієнтів.',
    setupHost: 'IP або ім\'я хоста сервера',
    setupPort: 'Порт WireGuard',
    setupPassword: 'Пароль адміністратора',
    setupCompleteBtn: 'Завершити налаштування',
    nodeSettings: 'Налаштування вузла',
    saveSettings: 'Зберегти налаштування',
    servers: 'Сервери',
    addNode: 'Додати сервер',
    nodeUrl: 'URL сервера (напр. http://ip:161)',
    nodeToken: 'Токен агента',
    nodeStatus: 'Статус',
    monitoring: 'Моніторинг',
    localNode: 'Локальний вузол',
  },
  ru: {
    name: 'Имя',
    password: 'Пароль',
    ...
    new: 'Создать',
    appSubtitle: 'AmneziaWG V2 Professional Hub',
    appDesigner: 'Design by @sky-night-net',
    ...
    setupTitle: 'Первоначальная настройка сервера',
    setupSubtitle: 'Настройте ваш VPN-узел перед созданием клиентов.',
    setupHost: 'IP или имя хоста сервера',
    setupPort: 'Порт WireGuard',
    setupPassword: 'Пароль администратора',
    setupCompleteBtn: 'Завершить настройку',
    nodeSettings: 'Настройки ноды',
  ...
  tr: { // Müslüm Barış Korkmazer @babico
    ...
    Permanent: 'Kalıcı',
    OneTimeLink: 'Tek kullanımlık bağlantı',
    setupTitle: 'Sunucu Kurulumu',
    setupSubtitle: 'VPN düğümünü yapılandırın.',
    setupHost: 'Sunucu IP veya alan adı',
    setupPort: 'WireGuard Portu',
    setupPassword: 'Yönetici Şifresi',
    setupCompleteBtn: 'Kurulumu Tamamla',
    nodeSettings: 'Düğüm Ayarları',
    saveSettings: 'Ayarları Kaydet',
    servers: 'Sunucular',
    addNode: 'Sunucu Ekle',
    nodeUrl: 'Sunucu URL (örn. http://ip:161)',
    nodeToken: 'Agent Token',
    nodeStatus: 'Durum',
    localNode: 'Yerel Düğüm',
  },
  no: { // github.com/digvalley
    ...
    madeBy: 'Laget av',
    donate: 'Doner',
    setupTitle: 'Serveroppsett',
    setupSubtitle: 'Konfigurer VPN-noden før du oppretter klienter.',
    setupHost: 'Server IP eller vertsnavn',
    setupPort: 'WireGuard Port',
    setupPassword: 'Adminpassord',
    setupCompleteBtn: 'Fullsør oppsett',
    nodeSettings: 'Node-innstillinger',
    saveSettings: 'Lagre innstillinger',
    servers: 'Servere',
    addNode: 'Legg til server',
    nodeUrl: 'Server URL (f.eks. http://ip:161)',
    nodeToken: 'Agent-token',
    nodeStatus: 'Status',
    ...
    Permanent: 'Permanent',
    theme: { dark: 'Mørkt tema', light: 'Lyst tema', auto: 'Automatisk tema' },
  },
  pl: { // github.com/archont94
    ...
    setupSubtitle: 'Skonfiguruj węzeł VPN przed tworzeniem klientów.',
    setupHost: 'IP lub nazwa hosta serwera',
    setupPort: 'Port WireGuard',
    setupPassword: 'Hasło administratora',
    setupCompleteBtn: 'Zakończ konfigurację',
    nodeSettings: 'Ustawienia węzła',
    saveSettings: 'Zapisz ustawienia',
    servers: 'Serwery',
    addNode: 'Dodaj serwer',
    nodeUrl: 'URL serwera (np. http://ip:161)',
    nodeToken: 'Token agenta',
    nodeStatus: 'Status',
    ...
    Permanent: 'Trwały',
    theme: { dark: 'Ciemny motyw', light: 'Jasny motyw', auto: 'Automatyczny motyw' },
  },
